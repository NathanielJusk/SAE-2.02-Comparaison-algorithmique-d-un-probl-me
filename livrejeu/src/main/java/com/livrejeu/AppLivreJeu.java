...
public class AppLivreJeu {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(">> ETAPE 6 : Exportez en .dot pour voir le graphe (choix 6).");
        System.out.println();
        ...
        while (continuer) {
            ...
            switch (choix) {
                ...
                case "2" -> {
                    ...
                    int n = saisirNbPages(scanner);
                    app.livre = new GenerateurV2().genererDepuisPages(pagesDisponibles, n, scanner);
                    System.out.println("   --> Passez au choix 3 pour afficher votre livre.");
                }
                ...
                default -> System.out.println("[!] Choix invalide. Entrez un chiffre entre 0 et 6.");
            }
            System.out.println();
        }
